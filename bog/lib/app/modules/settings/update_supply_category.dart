...
class _UpdateSupplyCategoryState extends State<UpdateSupplyCategory> {
  ...
  void initState() {
    ...
    getSupplyCategories = controller.userRepo
        .getData('/kyc-supply-category/fetch?userType=vendor');
    super.initState();
  }
              ...
              builder: (context, snapshot) {
                if (snapshot.connectionState == ConnectionState.waiting) {
                  ...
                  if (snapshot.data!.isSuccessful) {
                    final response =
                        SupplyCategory.fromJson(snapshot.data!.data);
                    ...
                    return Column(
                      children: [
                        CheckTiles(
                          ...
                          backEndCategories: oldCategories,
                          onAdd: (category) {
                          ...
                          child: AppButton(
                            ...
                            onPressed: () async {
                              ...
                              final res = await controller.userRepo.postData(
                                  '/kyc-supply-category/create', supplyCat);
