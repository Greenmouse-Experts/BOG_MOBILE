...
class UpdateKyc1 extends StatefulWidget {
  const UpdateKyc1({Key? key}) : super(key: key);

  static const route = '/UpdateKyc1';

  @override
  State<UpdateKyc1> createState() => _UpdateKyc1State();
}

class _UpdateKyc1State extends State<UpdateKyc1> {
