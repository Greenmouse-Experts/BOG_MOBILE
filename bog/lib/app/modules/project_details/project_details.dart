                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      TabBar(
                        ...
                        tabs: const [
                          Tab(text: 'Details',iconMargin: EdgeInsets.zero,),
                          Tab(text: 'Activity',iconMargin: EdgeInsets.zero,),
                        ],
                        onTap: (index) {
                            ...
                            SingleChildScrollView(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  _TextButton(text: "Photos & Notes ", onPressed: () {
                                  ...
                                  _TextButton(text: "Messages & Meetings", onPressed: () {
                                  ...
                                  _TextButton(text: "Uploaded Documents", onPressed: () {
                                  ...
                                  _TextButton(text: "Project Costing", onPressed: () {
