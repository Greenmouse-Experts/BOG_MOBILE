                         ...
                         return      Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    const SizedBox(height: 10),
                                    RowTitle(title: 'Project Name', detail: clientProject.title ?? ''),
                               
                                    const SizedBox(height: 10),
                                     RowTitle(title: 'Service Required', detail: clientProject.projectTypes ?? ''),
                                     const SizedBox(height: 10),
                                       RowTitle(title: 'Start Date', detail: clientProject.endDate ?? ''),
                                     const SizedBox(height: 10),
                                       RowTitle(title: 'Due Date', detail: clientProject.endDate ?? ''),
                                     const SizedBox(height: 10),
                                       RowTitle(title: 'Project Cost', detail: clientProject.endDate ?? ''),
                                     const SizedBox(height: 10),
                                    Divider(
                                      thickness: 1,
...
class RowTitle extends StatelessWidget {
  const RowTitle({
    super.key,
    required this.detail, required this.title,
  });
  ...
  Widget build(BuildContext context) {
    return Row(
      mainAxisSize: MainAxisSize.min,
      children: [
        Text(title, style: TextStyle(color: Colors.grey.withOpacity(0.9), fontSize: 16),),
     const   SizedBox(width: 10,),
        Text(detail, style: TextStyle(color: Colors.black, fontSize: 16, fontWeight: FontWeight.bold),)
      ],
    );
  }
}