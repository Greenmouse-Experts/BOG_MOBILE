                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: PageInput(
                                        hint: "Enter your name  ",
                                        label:
                                            "Upload architectural plan (If available) ",
                                        isFilePicker: true,
                                    ...
                                    Padding(
                                      ...
                                      child: PageInput(
                                        hint: "Enter your name  ",
                                        label:
                                            "Upload electrical plan (If available) ",
                                        isFilePicker: true,
                                      ...
                                      child: AppButton(
                                        ...
                                        onPressed: () async {
                                          if (formKey.currentState!
                                            ...
                                            body['electricalPlan'] = await dio
                                                .MultipartFile.fromFile(
                                              electricalPlan!.path,
                                              filename: electricalPlan!.path
                                                  .split('/')
                                                  .last,
                                            );
                                            var formData =
