...
const Color brown1b = Color(0xff3842121);
...
const Color black1 = Color(0xff1e1d1d);
// const Color black1 = Color(0xff1e1d1d);
const Color white = Color(0xFFFFFFFF);
const Color white1 = Color(0xffafafa);
const Color transparent = Color(0xff00000000);
const Color default_white = Color(0xffff3f3f3);

const Color tang0 = Color(0xfffa500);

const Color orange0 = Color(0xfffa500);
...
const Color orange01 = Color(0xfffa500);
const Color orange02 = Color(0xfffae19);
const Color orange03 = Color(0xfffb732);
const Color orange04 = Color(0xfffc04c);
const Color orange05 = Color(0xfffc966);
const Color orange06 = Color(0xfffd27f);
const Color orange07 = Color(0xfffdb99);
const Color orange08 = Color(0xfffe4b2);
const Color orange09 = Color(0xfffedcc);
const Color orange010 = Color(0xffff6e5);

const Color yellow0 = Color(0xfffff00);
...
const Color yellow01 = Color(0xfffff00);
const Color yellow02 = Color(0xfffff19);
const Color yellow03 = Color(0xfffff32);
const Color yellow04 = Color(0xfffff4c);
const Color yellow05 = Color(0xfffff66);
const Color yellow06 = Color(0xfffff7f);
const Color yellow07 = Color(0xfffff99);
const Color yellow08 = Color(0xfffffb2);
const Color yellow09 = Color(0xfffffcc);
const Color yellow010 = Color(0xfffffe5);
...
const Color red00 = Color(0xfff0000);
const Color red01 = Color(0xfff1919);
const Color red02 = Color(0xfff3232);
const Color red03 = Color(0xfff4c4c);
const Color red04 = Color(0xfff6666);
const Color red05 = Color(0xfff7f7f);
const Color red06 = Color(0xfff9999);
const Color red07 = Color(0xfffb2b2);
const Color red08 = Color(0xfffcccc);
const Color red09 = Color(0xfffe5e5);
...
const Color light_green010 = Color(0xfffffff);

const Color pink0 = Color(0xfff69b4);
...
const Color pink01 = Color(0xfff78bb);
const Color pink02 = Color(0xfff87c3);
const Color pink03 = Color(0xfff96ca);
const Color pink04 = Color(0xfffa5d2);
const Color pink05 = Color(0xfffb4d9);
const Color pink06 = Color(0xfffc3e1);
const Color pink07 = Color(0xfffd2e8);
const Color pink08 = Color(0xfffe1f0);
const Color pink09 = Color(0xffff0f7);
const Color pink010 = Color(0xfffffff);

const Color app_color = Color(0xff9275fe);
const Color app_color1 = Color(0xffbbaafc);
...
const Color brown010 = Color(0xfffffff);
...
const Color warm_grey_two = Color(0xff1e1d1d);
const Color warm_grey_three = Color(0xff8b8b8b);
const Color warm_grey_four = Color(0xff15171e);
...
const Color ivory = Color(0xff8efe6);
const Color ivory_dark = Color(0xff7e8d9);
...
// const Color buttonColor = Color(0xffBC89BC);

bool get darkMode => (ModeController.instance.darkMode); //The app is dark by default

Color get whiteColor =>darkMode?black:white;

Color get whiteColor2 => darkMode?dark_grey_two:white;

Color get whiteColor3 => darkMode?dark_grey_two:default_white;

Color get whiteColor4 =>darkMode?white.withOpacity(.2):default_white;

Color get blackColor=> darkMode?white:black;

Color get blackColor2 => darkMode?white:warm_grey_two;

Color get blackColor3 => darkMode?default_white:warm_grey_two;

Color get homepage_background => darkMode?white:warm_grey_four;

double get bestOpacity => darkMode?(.5):(.1);

double get bestOpacity2 => darkMode?(.3):(.1);

double get bestOpacity3 => darkMode?(.3):(.03);

double get bestOpacity4 => darkMode?(.2):(.03);
