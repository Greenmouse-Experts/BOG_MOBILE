...
class ClientProjectModel {
  ...
  factory ClientProjectModel.fromJson(Map<String, dynamic> json) =>
      ClientProjectModel(
        ...
        totalEndDate: json["totalEndDate"] == null
            ? null
            : DateTime.parse(json["totalEndDate"]),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "totalEndDate":
            "${totalEndDate!.year.toString().padLeft(4, '0')}-${totalEndDate!.month.toString().padLeft(2, '0')}-${totalEndDate!.day.toString().padLeft(2, '0')}",
...
class Transactions {
  ...
  factory Transactions.fromJson(Map<String, dynamic> json) => Transactions(
        commitmentFee: json["commitmentFee"] == null
            ? null
            : CommitmentFee.fromJson(json["commitmentFee"]),
        payouts: json["payouts"] == null
            ? []
            : List<dynamic>.from(json["payouts"]!.map((x) => x)),
      );

  Map<String, dynamic> toJson() => {
        "commitmentFee": commitmentFee?.toJson(),
        "payouts":
            payouts == null ? [] : List<dynamic>.from(payouts!.map((x) => x)),
      };
}
...
class CommitmentFee {
  ...
  factory CommitmentFee.fromRawJson(String str) =>
      CommitmentFee.fromJson(json.decode(str));
